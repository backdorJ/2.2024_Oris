                ...
                <div className={classes.card__abilities__block}>
                    <div className={classes.card__abilities__wrapper__img}>
                        <div className={classes.card__abilities__img}>
                            <span style={{color: "#FDD85D", fontWeight: 400}}>{abilities[0]?.name.charAt(0).toUpperCase()}</span>
                        </div>
                    </div>
                    <div className={classes.card__abilities__block_title}>
                        <p>{abilities[0]?.name.charAt(0).toUpperCase() + abilities[0]?.name.slice(1)}</p>
                    </div>
                </div>
                {
                    abilities[1]?.name &&
                    <div className={classes.card__abilities__block_2}>
                        <div className={classes.card__abilities__wrapper__img}>
                            <div className={classes.card__abilities__img}>
                                <span style={{color: "#FF844F", fontWeight: 400}}>{abilities[1]?.name.charAt(0).toUpperCase()}</span>
                            </div>
                        </div>
                        <div className={classes.card__abilities__block_title}>
                            <p>{abilities[1]?.name.charAt(0).toUpperCase() + abilities[1]?.name.slice(1)}</p>
                        </div>
                    </div>
                }
            </div>
